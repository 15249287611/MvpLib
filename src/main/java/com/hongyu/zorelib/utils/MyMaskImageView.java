 ...
 * 高斯模糊图片
 */
public class MyMaskImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public MyMaskImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public MyMaskImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public MyMaskImageView setMaskColor(int color) {
        this.color = color;
        return this;
    }
    ...
    public class GlideBlurTransformation extends CenterCrop {
        ...
        protected Bitmap transform(@NonNull BitmapPool pool, @NonNull Bitmap toTransform, int outWidth, int outHeight) {
            ...
            return blurBitmap(context, bitmap, 20, (int) (outWidth * 0.2), (int) (outHeight * 0.2));
        }
