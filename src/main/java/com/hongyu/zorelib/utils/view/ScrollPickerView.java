...
public class ScrollPickerView extends View {
    ...
    private Handler updateHandler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
        @Override
    ...
    public void setSelected(String mSelectItem) {
        if (TextUtils.isEmpty(mSelectItem)) return;
        setSelected(Math.max(mDataList.indexOf(mSelectItem), 0));
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mMaxTextSize = DensityTools.dp2px(context, 20);
    ...
    private void init() {
        ...
        mPaint.setTypeface(ResourcesCompat.getFont(context, R.font.roboto));
        mPaint.setColor(ContextCompat.getColor(context, R.color.color_text_black));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setTypeface(ResourcesCompat.getFont(context, R.font.roboto));
        nPaint.setColor(ContextCompat.getColor(context, R.color.color_666));
    }
