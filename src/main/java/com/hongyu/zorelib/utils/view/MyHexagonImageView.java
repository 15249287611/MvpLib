 ...
 * 六边形图片
 */
public class MyHexagonImageView extends  AppCompatImageView {
    ...
    public MyHexagonImageView(Context context) {
        super(context);
        init();
    }
    ...
    public MyHexagonImageView(Context context, AttributeSet attrs, int defStyleAttr) {
