...
@SuppressLint("DrawAllocation,CustomViewStyleable,Recycle")
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircularProgressView_backWidth, DensityTools.dp2px(getContext(),10)));
        ...
        mProgPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircularProgressView_progWidth, DensityTools.dp2px(getContext(),10)));
