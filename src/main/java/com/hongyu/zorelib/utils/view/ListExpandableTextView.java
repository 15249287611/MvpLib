 ...
 * </pre>
 */
public class ListExpandableTextView extends androidx.appcompat.widget.AppCompatTextView {
    private static final int DEFAULT_TRIM_LENGTH = 38;
    private static final String ELLIPSIS = "...  展开";
    ...
    public ListExpandableTextView(Context context) {
        this(context, null);
    }

    public ListExpandableTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private CharSequence getTrimmedText(CharSequence text) {
        if (text != null && text.length() > trimLength + 1) {
            ...
            TextAppearanceSpan textAppearanceSpan = new TextAppearanceSpan(null, 0, DensityTools.sp2px(getContext(), 14), redColors, null);
            spannableStringBuilder.setSpan(textAppearanceSpan, spannableStringBuilder.length() - 2, spannableStringBuilder.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
